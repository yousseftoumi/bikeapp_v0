...
class _AddBikeScreenState extends State<AddBikeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: app_bar(context, "Nouveau vélo"),
        body: Padding(
              ...
              Form(
                ...
                child: Column(
                  children: [
                    ...
                    builTextFormField(modelController, TextInputType.text, 1, 1,
                        TextInputAction.next, "  Modèle  "),
                    Padding(
                    ...
                    builTextFormField(ratingController, TextInputType.number, 1,
                        1, TextInputAction.next, "  Rating  "),
                    builTextFormField(speedController, TextInputType.number, 1,
                        1, TextInputAction.next, "  Speed  "),
                    builTextFormField(rangeController, TextInputType.number, 1,
                        1, TextInputAction.done, "  Range  "),
                    FittedBox(
                      child: Padding(
                        padding: const EdgeInsets.symmetric(vertical: 5),
                        child: Container(
